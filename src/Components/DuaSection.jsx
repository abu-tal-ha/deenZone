  ...
  const duasByCategory = {
    ...
    food: [
      ...
      },
      {
        ...
        bangla:
          "আলহামদুলিল্লাহিল্লাযী আতআমানা ওয়াসাক্বানা ওয়াজা’আলানা মিনাল মুসলিমীন",
        meaning: {
    ...
    sleep: [
      ...
      },
      {
        ...
        arabic:
          "اللَّهُ لَا إِلَٰهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ ... (আয়াতুল কুরসি সম্পূর্ণ)",
        bangla:
          "আল্লাহু লা ইলাহা ইল্লা হুয়াল হাইয়ুল ক্বাইয়ূম... (পূর্ণ আয়াতুল কুরসি পড়তে হবে)",
        meaning: {
      ...
      },
      {
        ...
        bangla:
          "আল্লাহুম্মা ইন্নী আসলামতু নাফসী ইলাইকা ... (পূর্ণ হাদিসের দোয়া)",
        meaning: {
      ...
      },
      {
        ...
        arabic:
          "أَعُوذُ بِكَلِمَاتِ اللَّهِ التَّامَّاتِ مِنْ غَضَبِهِ وَعِقَابِهِ ...",
        bangla:
          "আউযু বিকালিমাতিল্লাহিত তাম্মাতি মিন গাদ্বাবিহি ওয়া ইকাবিহি...",
        meaning: {
      ...
      },
      {
        ...
        arabic:
          "سُبْحَانَ اللَّهِ، الْحَمْدُ لِلَّهِ، اللَّهُ أَكْبَرُ (৩৩ বার করে)",
        bangla:
          "সুবহানাল্লাহ, আলহামদুলিল্লাহ, আল্লাহু আকবার (প্রত্যেকটি ৩৩ বার করে)",
        meaning: {
