      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Your trusted companion for Islamic learning, prayer times, and
              spiritual reminders.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="/prayer" className="hover:text-gray-300">
                  Prayer Times
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li className="flex items-center gap-2">
                <FaPhoneAlt />
                <a href="tel:+880 1820647468" className="hover:underline">
                  +880 1820647468
                </a>
              </li>
              <li className="flex items-start gap-2">
                <FaMapMarkerAlt />
                <span>Nagorkanda, Faridpur, Bangladesh</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-sm text-gray-400 text-center md:text-right">
            ...
            <span className="font-semibold text-white">Abu Talha</span>.
          </p>
